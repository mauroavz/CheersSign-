...
function App() {
  ...
  async function sendPDFToWebhook(pdf) {
    try {
      ...
      // Utiliza una expresión regular o métodos de cadena para extraer el parámetro
      const parametroMatch = currentURL.match(/\/(\d+x\d+)/);
      console.log(parametroMatch);
      const parametroSinBarra = parametroMatch[1]; // Obtiene la segunda captura
      console.log(parametroSinBarra);
              ...
              <button
                ...
                onClick={() => {
                  window.location.href =
                    "https://app.cheerscontracts.com/version-test/dashboard?&menu=All%20Contracts";
                }}
              >
                Volver
              </button>
